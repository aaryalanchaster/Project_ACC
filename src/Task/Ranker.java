...
public class Ranker {
    ...
    public static void main(String[] args) throws IOException {
        InvertedIndex invertedIndex1 = new InvertedIndex();
                        ...
                        for (String word : words) {
                            ...
                            for (String keyword : keywords) {
                                if (word.equalsIgnoreCase(keyword)) {
                                    Map<String, Integer> keywordCount = keywordCountMap.getOrDefault(keyword,
                                            new HashMap<>());
            ...
            for (String filename : sortByValue(keywordCountMap.get(keywords[0])).keySet()) {
                ...
                if (containsAllKeywords) {
                    ...
                    for (int i = 0; i < keywords.length; i++) {
                        System.out
                                .print(keywords[i] + ": " + keywordCountMap.get(keywords[i]).getOrDefault(filename, 0));
